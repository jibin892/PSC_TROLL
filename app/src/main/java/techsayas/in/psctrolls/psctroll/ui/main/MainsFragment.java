...
import techsayas.in.psctrolls.psctroll.Question;
import techsayas.in.psctrolls.psctroll.R;
import techsayas.in.psctrolls.psctroll.Test;
...
//        questions = ((Test) getActivity().getIntent().getExtras().get("Questions")).getQuestions();
//        TESTNAME = (String) getActivity().getIntent().getExtras().get("TESTNAME");
//        toolbar = root.findViewById(R.id.toolbar);
//        toolbar.setTitleTextColor(getResources().getColor(android.R.color.black));
//        answers = new String[questions.size()];
//        toolbar.setTitleTextColor(getResources().getColor(android.R.color.black));
//        scrollView = root.findViewById(R.id.discrete);
...
//        indexLayout = root.findViewById(R.id.index_layout);
//        indexLayout.setAlpha(.5f);
//        quesGrid = root.findViewById(R.id.pop_grid);
//        popGrid = new popGridAdapter(getActivity());
...
//        });
//
//        timer = ((Test) getActivity().getIntent().getExtras().get("Questions")).getTime() * 60 * 1000;
//        return root;
//    }
//
//    void showPopUp() {
...
//
//        try {
//            mDatabase.child("Results").child(((Test) getActivity().getIntent().getExtras().get("Questions")).getName())
...
//
//
//        getActivity().getMenuInflater().inflate(R.menu.attempt_menu, menu);
